...
class VisitorTracker
{
     ...
     */
    private $CONTROLLER_IGNORE_LIST = ['Signin', 'Signout', 'Dashboard', 'MyProfile', 'MyHistory', 'ManagePost', 'ManageTestimony', 'WebsiteSettings', 'ManageAdmins', 'Logs'];

    /*
     * ignore ip address
     */
    private $IP_IGNORE_LIST = ['127.0.0.1', '::1'];

    /*
     * visitor tracking table
     */
    private $visitors = "tbl_visitors";
